...
.. list-table::
   ...
   * - :doc:`Core <./reference/cpp_api/core>`
     - `cpp/include/ucxx/context.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/context.h>`_, `worker.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/worker.h>`_, `address.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/address.h>`_, `config.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/config.h>`_, `component.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/component.h>`_
   ...
   * - :doc:`Communication <./reference/cpp_api/communication>`
     - `cpp/include/ucxx/endpoint.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/endpoint.h>`_, `listener.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/listener.h>`_
     - UCP endpoint and listener management for establishing and accepting connections.

   * - :doc:`Request <./reference/cpp_api/request>`
     - `cpp/include/ucxx/request_tag.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/request_tag.h>`_, `request_stream.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/request_stream.h>`_, `request_am.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/request_am.h>`_, `request_mem.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/request_mem.h>`_
   ...
   * - :doc:`Memory <./reference/cpp_api/memory>`
     - `cpp/include/ucxx/buffer.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/buffer.h>`_, `memory_handle.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/memory_handle.h>`_, `remote_key.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/remote_key.h>`_
   ...
   * - :doc:`Async <./reference/cpp_api/async>`
     - `cpp/include/ucxx/future.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/future.h>`_, `notifier.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/notifier.h>`_, `delayed_submission.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/delayed_submission.h>`_
   ...
   * - :doc:`Utilities <./reference/cpp_api/utils>`
     - `cpp/include/ucxx/typedefs.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/typedefs.h>`_, `header.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/header.h>`_, `exception.h <https://github.com/ROCm-DS/hip-ucxx/blob/release/rocmds-26.03/cpp/include/ucxx/exception.h>`_
