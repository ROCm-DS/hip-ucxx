...
This is a UCX Memory optimization which toggles whether UCX library intercepts memory allocation calls. hipUCXX defaults this value to `n`. There are [known issues](https://github.com/openucx/ucx/wiki/NVIDIA-GPU-Support#known-issues) when using this feature.
