...
| ACK | Acknowledge |
| am | Active Message |
| amdsmi | AMD System Management Interface library |
...
| KFD | Kernel Fusion Driver (AMD GPU kernel driver) |
...
| ROCm | Radeon Open Compute platform (AMD). The open software platform for GPU-accelerated computing on AMD hardware. |
...
| WQE | Work Queue Elements (pronounced "WOOKIE") |
| WR | Work Request |
| XGMI | AMD inter-GPU high-speed interconnect (analogous to NVLink) |
