...
Below we go into more detail as we create an echo server in UCX and compare with [Python Sockets](https://docs.python.org/3/library/socket.html#example).
...
Again, an `Endpoint` sends and receives with [unique tags](http://openucx.github.io/ucx/api/latest/html/group___u_c_t___t_a_g.html).
